...
class EtudesController extends AbstractController
{
     ...
     */
    public function new(Request $request, EtudesRepository $etudesRepository): Response
    {
        $etude = new Etudes();
     ...
     */
    public function edit(Request $request, Etudes $etude, EtudesRepository $etudesRepository): Response
    {
        $form = $this->createForm(EtudesType::class, $etude);
        $form->handleRequest($request);
     ...
     */
    public function delete(Request $request, Etudes $etude, EtudesRepository $etudesRepository): Response
    {
